...
namespace TranslatorApkTests.Logic
{
    ...
    public class FunctionsTest
    {
        ...
        {
            Assert.AreEqual(1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2", "1.0.0.0"));
            Assert.AreEqual(1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2", "1.0.0.0"));
            Assert.AreEqual(1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2.3.000001", "1.2.3.00000"));
            Assert.AreEqual(1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2.3.000100", "1.2.3.000001"));
            Assert.AreEqual(1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2.3.000100", "1.2.3.0001"));
            Assert.AreEqual(0, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2.3.00000", "1.2.3.00000"));
            Assert.AreEqual(-1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2.3.000000", "1.2.3.001000"));
            Assert.AreEqual(-1, TranslatorApk.Logic.Utils.Utils.CompareVersions("1.2", "1.2.3"));
        }
        ...
        public void GetAllAttributesProcessTest()
        {
            ...
            TranslatorApk.Logic.Utils.Utils.GetAllAttributesProcess(doc.DocumentElement.ChildNodes[0], source);
            TranslatorApk.Logic.Utils.Utils.GetAllAttributesProcess(doc.DocumentElement.ChildNodes[0], source2);
