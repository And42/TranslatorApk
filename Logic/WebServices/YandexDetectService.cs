...
namespace TranslatorApk.Logic.WebServices
{
    public static class YandexDetectService
    {
        public static YandexDetectResponse Detect(string text)
        {
            ...
            return TranslateService.GetResponseFromJson<YandexDetectResponse>(Utils.WebUtils.DownloadString(link, DefaultSettingsContainer.Instance.TranslationTimeout));
        }
    }
}
