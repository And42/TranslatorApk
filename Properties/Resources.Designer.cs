...
namespace TranslatorApk.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на values-en-rGB|values-ar|values-af|values-be|values-bg|values-hr|values-hu|values-vi|values-nl|values-el|values-da|values-zu|values-iw|values-in|values-es|values-it|values-ca|values-zh|values-zh-rCN|values-zh-rTW|values-lv|values-lt|values-ms|values-de|values-nb|values-fa|values-pl|values-pt|values-ro|values-ru|values-sr|values-sk|values-sl|values-sw|values-tl|values-th|values-tr|values-uk|values-fi|values-fr|values-hi|values-cs|values-sv|values-et|values-ja.
        /// </summary>
        public static string FoldersOfLanguages {
            get {
                return ResourceManager.GetString("FoldersOfLanguages", resourceCulture);
            }
        }
